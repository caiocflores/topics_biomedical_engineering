...
load pf_f2y03_linear.mat % general rri 
open('patient')
...
figure(1)
[Sxx, f] = pyulear(rri_serie, 16, 1024);
...
title('RRI Time Series (Raw) - f2y02');
...
saveas(gcf, 'raw_rri_f2y03.png');

% print areas
sprintf('Young Subject - f2y03: \n VLF  = %f \n LF   = %f \n HF   = %f', relat_area_VLF, ...
