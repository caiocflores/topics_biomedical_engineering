...
load pf_f2o03_linear.mat % general rri 
open('patient')
...
[Sxx, f] = pyulear(rri_serie, 16, 256);
...
title('RRI Time Series (Raw) - f2o03');
...
saveas(gcf, 'raw_rri_f2o03.png');

% print areas
sprintf('Elderly Subject - f2o03: \n VLF  = %f \n LF   = %f \n HF   = %f', relat_area_VLF, ...
